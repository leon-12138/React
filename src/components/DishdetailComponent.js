        ...
        return(
            <React.Fragment>
                <Button outline onClick={this.toggleModal}>
                    <span className="fa fa-pencil fa-lg"></span> Login Comment
                </Button>
                        ...
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={12}>
                                    ...
                                    <Errors className="text-danger" model=".author" show="touched" messages={{ required: 'Required', minLength: "Must >= 3 chars", maxLength: "Must <= 15 chars" }} />
                                </Col>
                            </Row>
                            <Row className="form-group">
...
function RenderComments({comments}) {
    if (comments != null) {
        const rightPart = comments.map((comment) => {
            return(
                <div key = {comment.id}>
                    <p>{comment.comment}</p>
